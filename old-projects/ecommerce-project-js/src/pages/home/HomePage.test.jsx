...
describe('HomePage component', () => {
  ...
  it('clicks the add to cart button', async () => {
    render(
      <MemoryRouter>
        <HomePage cart={[]} loadCart={loadCart} />
      </MemoryRouter>
    ...
    const selector1 = within(productContainers[0]).getByTestId('quantity-selector');
    const selector2 = within(productContainers[1]).getByTestId('quantity-selector');
